...
export const tags = {
  ask: {
    ...
    color: red,
    description:
      'Instead of asking to ask, ask your question instead.' +
  ...
  bot: {
    ...
    color: blue,
    description:
      'Please use commands related to the bot in the' +
  ...
  canudont: {
    ...
    image: {
      url:
        'https://cdn.discordapp.com/attachments/174075418410876928/428989988286365696/can_u_dont.jpg',
    },
  },
  channels: {
    ...
    color: orange,
    description:
      'It would be greatly appreciated if you kept your posting' +
  ...
  code: {
    ...
    fields: [
      ...
      {
        name:
          'For syntax highlighting replace lang with the language (js,' +
          ' css, html, etc.):',
      ...
      },
      {
        ...
        value:
          'You can find more information on code blocks from [Discord Support](https://support.discordapp.com/hc/en-us/articles/210298617-Markdown-Text-101-Chat-Formatting-Bold-Italic-Underline-)',
      },
    ],
  },
  cs: {
    ...
    image: {
      url:
        'https://cdn.discordapp.com/attachments/174075418410876928/377425219872096256/maxresdefault.png',
    },
  },
  design: {
    ...
    color: purple,
    description:
      'Looking to improve your design skills? Here are some helpful' +
      'articles.',
    fields: [
      {
        name:
          '[7 Tips for Cheating at Design](https://medium.com/refactoring-ui/7-practical-tips-for-cheating-at-design-40c736799886)',
      },
      {
        name:
      ...
      {
        name:
          '[The Secret Heroes of UX Design](https://link.medium.com/XrKhnmTAsT)',
      },
      {
        name:
          '[Color Pallete](https://refactoringui.com/previews/building-your-color-palette/)',
      },
      {
        name:
          '[Color Usage](https://www.smashingmagazine.com/2017/09/vibrant-colors-apps-websites/)',
      },
      {
        name:
          '[Using Gradients](https://www.smashingmagazine.com/2018/01/gradients-user-experience-design/)',
      },
    ],
  },
  dog: {
    ...
    image: {
      url:
        'https://cdn.discordapp.com/attachments/174075418410876928/436958508039012379/unknown.png',
    },
  },
  doubt: {
    title: '[x] Doubt',
    ...
    image: {
      url:
        'https://media.discordapp.net/attachments/174075418410876928/435482310612221993/doubt.jpg?width=400&height=228',
    },
  },
  editor: {
    ...
    color: blue,
    description:
      'There are many different ways to edit code, from code' +
    ...
    fields: [
      {
        name: 'IDEs',
        value:
          'IDEs (Integrated Development Environment) are programs that' +
      ...
      },
      {
        name: 'Code Editors',
        value:
          'Code editors are text editors that usually include syntax' +
      ...
      },
      {
        ...
        value:
          'These IDEs, as they have a full suite of tools for' +
      ...
      },
      {
        name: 'Visual Studio',
        value:
          'Visual studio is a full IDE made by microsoft. It works well' +
      ...
      },
      {
        name: 'NetBeans',
        value:
          "I honestly don't know much about NetBeans, having never" +
      ...
      },
      {
        name: 'Atom',
        value:
          "Atom is a code editor based on web technology. It's made by" +
          ' GitHub, and has a massive community, with plugins for everything. [Download](https://atom.io/)',
      },
      {
        name: 'VS Code',
        value:
          'VS Code is another editor based off of web technology, but' +
      ...
      },
      {
        name: 'Sublime Text',
        value:
          'Sublime text starts off as a nice small and fast editor.' +
      ...
      },
      {
        name: 'Vim',
        value:
          'Vim is a command line text editor with plugins that can do' +
      ...
      },
      {
        name: 'Brackets',
        value:
          'Brackets is also based on web tech, and has a live reload' +
      ...
      },
      {
        name: 'Notepad++',
        value:
          'Notepad++ is a very lightweight code editor, with a lot ' +
  ...
  fasy: {
    ...
    image: {
      url:
        'https://media.discordapp.net/attachments/174075418410876928/435887256843321354/loamy.jpg?width=401&height=84',
    },
  },
  fetch: {
    ...
    fields: [
      ...
      },
      {
        name: 'Fetch HTTPlib',
        value:
          '[A Fetch library that assists with learning how to use fetch.](https://codepen.io/papaamazon-the-flexboxer/project/editor/DWwjNM)',
      },
      {
        name: 'Fetch tutorial',
        value:
          '[A tutorial that shows how to use fetch to get data from an API.](https://scotch.io/tutorials/how-to-use-the-javascript-fetch-api-to-get-data)',
      },
      {
        name: 'MDN fetch usage example',
        value:
          '[A very in depth write up write-up on how to use fetch.](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch_)',
      },
    ],
  },
  flex: {
    ...
    fields: [
      ...
      },
      {
        ...
        value:
          '[Learn flexbox in minutes! Easy, and powerful!](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)',
      },
      {
        name: 'Flexbox Froggy',
        value:
          '[Get frogs to where they need to be with the magic of flexbox!](https://flexboxfroggy.com)',
      },
      {
        name: 'Flexbox Defense',
        value:
          '[Blast enemies into nothingness with defensive towers positioned by flexbox!](http://www.flexboxdefense.com/)',
      },
    ],
  },
  framework: {
    ...
    color: green,
    description:
      'There is a large debate as to which framework is the best' +
      ' for your webapp, and this is just an overview of the top contenders.',
    fields: [
      {
        name: 'Vue',
        value:
          'Vue is a web framework that is easy to learn and use while' +
      ...
      },
      {
        name: 'React',
        value:
          'React is not a framework, and is rather a library. It is' +
      ...
      },
      {
        name: 'Angular 5',
        value:
          'I do not know as much about Angular as I do Vue and React,' +
    ...
    footer: {
      text:
        'My personal recommendation is Vue but definitely try out the' +
  ...
  gbp: {
    ...
    color: green,
    description:
      'Good Boye Points (GBP) are the best way to tell if a user' +
    ...
    fields: [
      {
        name: 'MDN Web Docs',
        value:
          '[CSS Grid Layout Docs](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout)',
      },
      {
        name: 'CSS Grid Quickstart Guide',
        value:
          '[A quick and dirty guide to CSS Grid.](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Grid_Layout)',
      },
      {
  ...
  jobs: {
    ...
    color: blue,
    description:
      'No job offers allowed on this server please. Free work is' +
  ...
  nice: {
    ...
    image: {
      url:
        'https://cdn.discordapp.com/attachments/287200463382642689/433326230495035412/1447912710960.jpg',
    },
  },
  oss: {
  ...
  pen: {
    ...
    fields: [
      ...
      },
      {
        ...
        value:
          'CodeSandbox is a great place to play around with a full node' +
  ...
  research: {
    ...
    description:
      'Search, research, and keep track of what you find. Even if you ' +
  ...
  roadmap: {
    ...
    color: blue,
    description:
      'This is a very nice outline on the general technologies' +
    ...
    fields: [
      {
        name: 'PDO',
        value:
          '[Prepared statements with PDO](https://secure.php.net/manual/en/pdo.prepared-statements.php).',
      },
      {
        name: 'Mysqli',
        value:
          '[Prepared statements with mysqli](https://secure.php.net/manual/en/mysqli.quickstart.prepared-statements.php).',
      },
    ],
  },
  template: {
    ...
    fields: [
      ...
      },
      {
        ...
        value:
          'How long will this project take? How much time can someone expect to commit to this project? Is there a deadline or desired date of completion?',
      },
      {
        name: 'Languages',
      ...
      },
      {
        name: 'Skill Level',
        value:
          'What skill level are you looking for? Are you willing to work with junior developers or prefer middle/senior level developers?',
      },
      {
        name: 'Communication',
        value:
          'What is the preferred method of communication? If a developer is interested, how should they contact you? Do NOT give out email addresses or other personally identifiable information.',
      },
    ],
  },
  thanks: {
    ...
    color: blue,
    description:
      'Thanking someone is a nice way to appreciate the help they have given you' +
  ...
  whynojobs: {
    ...
    color: blue,
    description:
      'In the past, there have been multiple cases of people' +
